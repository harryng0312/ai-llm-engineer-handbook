...
1. [Vì sao dùng Rust cho AI](#chương-151--vì-sao-dùng-rust-cho-ai)
2. [Kiến trúc: Rust Gateway đứng trước Python AI Service](#chương-152--kiến-trúc-rust-gateway-đứng-trước-python-ai-service)
3. [Rust Gateway hoàn chỉnh hơn: rate limiting và auth](#chương-153--rust-gateway-hoàn-chỉnh-hơn-rate-limiting-và-auth)
4. [Bài tập](#chương-154--bài-tập)
5. [Tài liệu tham khảo](#chương-155--tài-liệu-tham-khảo)

---

## Chương 15.1 — Vì sao dùng Rust cho AI
...
## Chương 15.2 — Kiến trúc: Rust Gateway đứng trước Python AI Service
...
Việc cần làm khi chuyển sang Rust: **giữ nguyên phần Python** (ingest + agent LangGraph) làm một service riêng expose qua HTTP nội bộ (giống `server.py` trong dự án Trợ lý RAG + Agent, xem [16-Projects.md](../16-Projects/16-Projects.md)), rồi thêm một lớp Rust (`axum`) đứng trước làm reverse proxy / gateway kiêm xử lý các phần cần hiệu năng cao (rate limiting, auth, streaming response):
...
## Chương 15.3 — Rust Gateway hoàn chỉnh hơn: rate limiting và auth
...
## Chương 15.5 — Tài liệu tham khảo
