...
> 📓 Toàn bộ code ví dụ trong chương này cũng có ở dạng notebook chạy được: [`08-Embedding.ipynb`](./08-Embedding.ipynb).

## Mục lục

1. [Embedding là gì](#chương-81--embedding-là-gì)
2. [Contrastive Learning](#chương-82--contrastive-learning)
3. [Triplet Loss](#chương-83--triplet-loss)
4. [Các model embedding: BGE/E5/GTE](#chương-84--các-model-embedding-bgee5gte)
5. [Tìm kiếm vector: từ brute-force đến ANN](#chương-85--tìm-kiếm-vector-từ-brute-force-đến-ann)
6. [FAISS](#chương-86--faiss)
7. [Qdrant](#chương-87--qdrant)
8. [Bài tập](#chương-88--bài-tập)
9. [Tài liệu tham khảo](#chương-89--tài-liệu-tham-khảo)

---

## Chương 8.1 — Embedding là gì
...
Ý tưởng ánh xạ văn bản thành vector không mới — [05-Deep-Learning.md Chương 5.5](../05-Deep-Learning/05-Deep-Learning.md#chương-55--word-embeddings) đã giới thiệu word2vec: 1 vector tĩnh cho mỗi **từ** đơn lẻ, học không giám sát từ đồng xuất hiện. Embedding hiện đại (BGE/E5) khác ở 2 điểm: sinh vector cho cả **câu/đoạn văn** thay vì từng từ, và học **có giám sát** bằng contrastive learning (mục sau) trên hàng triệu cặp câu.

## Chương 8.2 — Contrastive Learning
...
$$L = -\log \frac{\exp(\text{sim}(a, p) / \tau)}{\sum_i \exp(\text{sim}(a, n_i) / \tau)}$$
...
## Chương 8.4 — Các model embedding: BGE/E5/GTE
...
## Chương 8.5 — Tìm kiếm vector: từ brute-force đến ANN
...
## Chương 8.9 — Tài liệu tham khảo

> 📖 Xem chú giải chi tiết "vì sao mỗi paper quan trọng" ở [17-Papers §3](../17-Papers/17-Papers.md).
