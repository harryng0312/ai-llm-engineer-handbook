...
> 📓 Toàn bộ code ví dụ trong chương này cũng có ở dạng notebook chạy được: [`06-Embedding.ipynb`](./06-Embedding.ipynb).

## Mục lục

1. [Embedding là gì](#chương-61--embedding-là-gì)
2. [Contrastive Learning](#chương-62--contrastive-learning)
3. [Triplet Loss](#chương-63--triplet-loss)
4. [Các model embedding: BGE/E5/GTE](#chương-64--các-model-embedding-bgee5gte)
5. [Tìm kiếm vector: từ brute-force đến ANN](#chương-65--tìm-kiếm-vector-từ-brute-force-đến-ann)
6. [FAISS](#chương-66--faiss)
7. [Qdrant](#chương-67--qdrant)
8. [Bài tập](#chương-68--bài-tập)
9. [Tài liệu tham khảo](#chương-69--tài-liệu-tham-khảo)

---

## Chương 6.1 — Embedding là gì
...
## Chương 6.2 — Contrastive Learning
...
## Chương 6.4 — Các model embedding: BGE/E5/GTE
...
## Chương 6.5 — Tìm kiếm vector: từ brute-force đến ANN
...
## Chương 6.9 — Tài liệu tham khảo

> 📖 Xem chú giải chi tiết "vì sao mỗi paper quan trọng" ở [15-Papers §3](../15-Papers/15-Papers.md).
